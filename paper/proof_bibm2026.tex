...
% [CUT SECOND] -- delete this paragraph if the document runs to 6 pages.
...
% [CUT FIRST] -- delete this sentence if the document runs to 6 pages.
The three subgroups hold 15, 16 and 14 people, so these are descriptive figures
and we do not read a trend into them.
